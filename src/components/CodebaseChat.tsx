...
import { generateClientSideChatResponse } from "@/lib/repoAnalyzer";
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (!resp.ok || !resp.body) {
        throw new Error("Edge function response error");
      }
      ...
      // Fall back to client side codebase assistant response
      const fallbackReply = generateClientSideChatResponse(repoName, userQuery);
